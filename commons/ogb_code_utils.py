...
# # Terrible hack: precomputing NUM_NODETYPES and NUM_NODEATTRIBUTES, then store them as magic numbers
# all_data = DglGraphPropPredDataset(name='ogbg-code2', root='dataset')
# nodetypes_mapping = pd.read_csv(os.path.join(all_data.root, 'mapping', 'typeidx2type.csv.gz'))
# nodeattributes_mapping = pd.read_csv(os.path.join(all_data.root, 'mapping', 'attridx2attr.csv.gz'))
